        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {articlesRecents.length > 0 ? (
            <>
              ...
              {totalArticles > 4 && <div className="text-center"><Link href="/blog" className="btn-secondary text-sm sm:text-base px-6 sm:px-8 py-3 sm:py-4">Voir tous les articles ({totalArticles})</Link></div>}
            </>
          ) : (
